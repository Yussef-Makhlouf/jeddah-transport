  ...
  return (
    <main className="relative min-h-screen pt-32">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/3 left-1/4 w-32 h-32 border-4 border-[#00B272]/20 rounded-full animate-spin-slow"></div>
        <div className="absolute bottom-1/4 right-1/3 w-24 h-24 bg-[#00A4D6]/10 rotate-45"></div>
        <div className="absolute top-1/2 right-1/4 w-16 h-16 border-2 border-[#89C100]/30 rounded-lg animate-bounce-slow"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24">
          {[
            ...
            <div 
              key={index}
              className="group bg-white/80 backdrop-blur-md p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
            >
