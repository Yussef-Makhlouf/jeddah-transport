    ...
    <main className="relative min-h-screen w-full overflow-x-hidden ">
      ...
      <section className="relative pt-32 w-full">
        <div className="absolute inset-0">
          ...
          <div className="absolute top-20 right-20 w-72 md:w-96 h-72 md:h-96 bg-[#00B272]/10 rounded-full blur-3xl animate-pulse-slow"></div>
          <div className="absolute bottom-20 left-20 w-72 md:w-96 h-72 md:h-96 bg-[#00A4D6]/10 rounded-full blur-3xl animate-pulse-slower"></div>
          
          {/* Decorative Elements */}
          <div className="absolute top-1/3 left-1/4 w-24 md:w-32 h-24 md:h-32 border-4 border-[#00B272]/20 rounded-full animate-spin-slow"></div>
          <div className="absolute bottom-1/4 right-1/3 w-20 md:w-24 h-20 md:h-24 bg-[#00A4D6]/10 rotate-45"></div>
          <div className="absolute top-1/2 right-1/4 w-12 md:w-16 h-12 md:h-16 border-2 border-[#89C100]/30 rounded-lg animate-bounce-slow"></div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-16 md:mb-24">
            ...
            <div className="space-y-6 md:space-y-8">
              <h2 className="text-2xl md:text-3xl font-bold text-[#003466]">خبرة تقنية متميزة</h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={index} className="flex items-center gap-2 text-[#003466]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-16 md:mb-24">
            {[
              ...
              <div key={index} className="group bg-white/80 backdrop-blur-md p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                ...
                <h3 className="text-xl font-bold text-[#003466] mb-2">{item.title}</h3>
        ...
        {/* FAQ Section */}
        <div className="relative bg-gradient-to-b from-amber-50 via-white to-rose-50 py-16 md:py-24">
          <FAQ/>
        </div>
