...
export const metadata: Metadata = {
  title: {
    default:
      "شركة ترميز كود | تطوير وبرمجة المواقع والتطبيقات في المملكة العربية السعودية",
    template: "%s | شركة ترميز كود",
  },
  description:
    "شركة رائدة في مجال تطوير وبرمجة المواقع والتطبيقات. نقدم حلول تقنية متكاملة وخدمات برمجية احترافية مع ضمان الجودة",
  keywords: [
    "تطوير مواقع",
    "برمجة تطبيقات",
    "تصميم مواقع",
  ...
  openGraph: {
    ...
    description:
      "حلول تقنية متكاملة وخدمات برمجية احترافية في المملكة العربية السعودية",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
