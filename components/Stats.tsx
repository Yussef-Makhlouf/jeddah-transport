...
//   return (
//     <section className="relative py-24 overflow-hidden bg-inherit text-secondary">
//       {/* Dynamic Background */}
...
//             <div
//               key={index}
//               className="group relative bg-white/10 backdrop-blur-md rounded-2xl p-6 hover:bg-white/15 transition-all duration-300"
//             >
//               {/* Decorative Corner */}
//               <div className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-br ${stat.gradient} opacity-10 rounded-tr-2xl rounded-bl-full transform group-hover:scale-110 transition-transform duration-300`} />
              
//               {/* Icon */}
//               <div className={`relative w-16 h-16 mb-6 bg-gradient-to-r ${stat.gradient} rounded-xl flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300`}>
...
//                 />
//                 <span className="text-2xl font-bold text-white">{stat.suffix}</span>
//               </div>
...
//           <div className="bg-white/5 backdrop-blur-md rounded-2xl p-8 flex items-center gap-8">
//             <BarChart3 className="w-16 h-16 text-[#00B272]" />
//             <div>
//               <h4 className="text-2xl font-bold text-black mb-2">معدل نمو سنوي</h4>
...
//             <div>
//               <h4 className="text-2xl font-bold text-black mb-2">رضا العملاء</h4>
//               <div className="w-full bg-white/10 rounded-full h-3">
...
export default function Stats() {
  return (
    <section className="relative py-24 overflow-hidden bg-gradient-to-br from-white via-[#f0f9ff] to-[#e6fffa]">
      {/* Dynamic Background */}
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-grid-pattern opacity-10"></div>
        {[...Array(3)].map((_, i) => (
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="group relative bg-white/10 backdrop-blur-md rounded-2xl p-6 hover:bg-white/20 transition-all duration-300"
            >
              <div
              ...
              <div className="flex items-baseline gap-1 mb-2">
                ...
                />
                <span className="text-2xl font-bold text-gray-800">{stat.suffix}</span>
              </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 flex items-center gap-8">
            <BarChart3 className="w-16 h-16 text-[#00B272]" />
            <div>
              <h4 className="text-2xl font-bold text-gray-800 mb-2">معدل نمو سنوي</h4>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 flex items-center gap-8">
            <Target className="w-16 h-16 text-[#00A4D6]" />
            <div>
              <h4 className="text-2xl font-bold text-gray-800 mb-2">رضا العملاء</h4>
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div className="h-full w-[95%] bg-gradient-to-r from-[#003466] to-[#00A4D6] rounded-full" />
              </div>
            </div>
