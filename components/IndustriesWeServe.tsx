      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-6xl font-bold mb-6">
            <span className="text-[#003466]">نبني</span>{' '}
            <span className="text-[#89C100]">حلول</span>{' '}
            <span className="text-[#00B272]">لكل صناعة</span>
          </h2>
          ...
          {industries.map((industry, index) => (
            <div key={index} className="relative">
              ...
              <div className="absolute inset-0 -z-10">
                <div className={`absolute top-0 ${index % 2 === 0 ? 'right-0' : 'left-0'} w-96 h-96 ${industry.color}/10 rounded-full blur-3xl`}></div>
              </div>
              ...
              <div className={`flex flex-col lg:flex-row items-center gap-16 ${
                ...
                <div className="w-full lg:w-1/2 space-y-8">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-4xl font-bold text-[#003466]">{industry.title}</h3>
                  </div>
                  ...
                  <div className="space-y-4">
                    {industry.projects.map((project, idx) => (
                      <div 
                        key={idx}
                        className="flex items-center gap-4 bg-white/80 backdrop-blur-md p-4 rounded-xl border border-[#00A4D6]/20 hover:shadow-lg transition-all duration-300"
                      >
                  ...
                  <div className="flex items-center gap-8 pt-6">
                    <div className="text-center">
                      <div className="text-3xl font-bold text-[#003466]">98%</div>
                      <div className="text-sm text-gray-600">رضا العملاء</div>
                    </div>
                    <div className="text-center">
                      <div className="text-3xl font-bold text-[#003466]">+50</div>
                      <div className="text-sm text-gray-600">مشروع منجز</div>
                    </div>
                    <div className="text-center">
                      <div className="text-3xl font-bold text-[#003466]">24/7</div>
                ...
                <div className="w-full lg:w-1/2">
                  <div className="relative aspect-[4/3] rounded-3xl overflow-hidden group">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-[#003466]/80 to-transparent"></div>
